...
function StepIndicator({ step, isActive }: { step: PipelineStep; isActive: boolean }) {
  ...
  return (
    ...
    >
      ...
      {step.status === 'in_progress' ? (
        ...
        >
          <Icon className={`w-[clamp(24px,3vw,32px)] h-[clamp(24px,3vw,32px)] ${config.color}`} />
        </motion.div>
        ...
        >
          <Icon className={`w-[clamp(28px,3.5vw,36px)] h-[clamp(28px,3.5vw,36px)] ${config.color} stroke-3`} />
        </motion.div>
      ) : (
        <Icon className={`w-[clamp(24px,3vw,32px)] h-[clamp(24px,3vw,32px)] ${config.color}`} />
      )}
...
export function ProcessingPipeline({ steps, currentStep, onComplete }: ProcessingPipelineProps) {
    ...
    <Card className="p-[clamp(24px,3vw,40px)] border-2 border-black rounded-[5px] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-white">
      ...
      {allComplete && (
        <motion.div
          ...
          className="mt-[clamp(24px,3vw,32px)] p-[clamp(16px,2vw,20px)] bg-custom-green border-2 border-green-600 rounded-[5px] shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] text-center"
        >
          <p className="text-[clamp(15px,2vw,18px)] font-bold text-green-600 uppercase tracking-wide">
            ✓ Processing Complete!
          </p>
          <p className="text-[clamp(12px,1.4vw,13px)] text-black/70 mt-[clamp(4px,0.5vw,6px)]">
