...
const features = [
  {
    ...
    icon: (
      <svg className="w-[clamp(40px,5vw,56px)] h-[clamp(40px,5vw,56px)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
function FeatureCard({ title, description, icon }: { title: string; description: string; icon: React.ReactNode }) {
  ...
  return (
    ...
    >
      ...
      <h4 className="font-bold mb-2 text-[clamp(18px,2vw,24px)]">{title}</h4>
